...
I have spent eight years shipping web applications, APIs, and e-commerce systems for B2B teams. This is what I would look for if I were on your side of the table—and what you can expect when you [review my work](/work) or [download my resume](/Nicholas_Loperena_Resume_v10.pdf).
...
1. **Communicate in writing** — design notes, PR descriptions, and async updates
2. **Ship without constant direction** — break work into reviewable chunks
3. **Respect time zones** — I am **US-based (EST)** from Kissimmee, FL with predictable overlap for US teams
4. **Document decisions** — so the next engineer is not guessing in month three
...
1. **Recruiter screen (30 min):** scope, comp band, remote policy, timeline
2. **Technical deep dive (60 min):** one production system, architecture tradeoffs
3. **Pairing or take-home (optional):** small feature with tests, not unpaid multi-day builds
4. **Cross-functional (30 min):** product or design collaboration style
...
- [View experience & resume](/about)
- [See production work](/work)
- [Get in touch](/about) via the contact form
