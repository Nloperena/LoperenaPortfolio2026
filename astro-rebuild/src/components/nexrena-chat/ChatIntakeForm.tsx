...
import { submitChatIntake, type ChatIntakePrefill } from '@/lib/nexrena-chat/chat-api';
...
export function ChatIntakeForm({ sessionId, siteKey = 'nexrena', teamLabel = 'the team', prefill, onSuccess, onError }: Props) {
  ...
  return (
    <form id="chat-intake" className="site-chat-intake" onSubmit={(e) => void onSubmit(e)}>
      <p className="site-chat-intake-title">Send your details to {teamLabel}</p>
